...
syn keyword mapDefine       PROJECTION QUERYMAP REFERENCE SCALEBAR STYLE SYMBOL VALIDATION WEB

" General keywords second order
syn keyword mapIdentifier   ALIGN ALPHACOLOR ANCHORPOINT ANGLE ANTIALIAS
syn keyword mapIdentifier   BACKGROUNDCOLOR BACKGROUNDSHADOWCOLOR BACKGROUNDSHADOWSIZE BUFFER
syn keyword mapIdentifier   CENTER CHARACTER CLASSGROUP CLASSITEM COLOR CONFIG CONNECTION CONNECTIONTYPE
syn keyword mapIdentifier   DATA DATAPATTERN DEBUG DEFRESOLUTION DRIVER DUMP
...
syn keyword mapIdentifier   INCLUDE IMAGE IMAGECOLOR IMAGEMODE IMAGEPATH IMAGEQUALITY IMAGETYPE IMAGEURL INDEX INITIALGAP INTERLACE INTERVALS
